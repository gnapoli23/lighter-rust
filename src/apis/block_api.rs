...
pub async fn block(
    ...
    by: &str,
    value: &str,
) -> Result<models::Blocks, Error<BlockError>> {
...
pub async fn blocks(
    ...
    index: Option<i64>,
    sort: Option<&str>,
) -> Result<models::Blocks, Error<BlocksError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
/// Get current height
pub async fn current_height(
    configuration: &configuration::Configuration,
) -> Result<models::CurrentHeight, Error<CurrentHeightError>> {
